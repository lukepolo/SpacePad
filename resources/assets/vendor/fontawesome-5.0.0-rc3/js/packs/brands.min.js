!(function() {
  ...
  function c(c) {
    "function" == typeof V.hooks.addPack
      ? V.hooks.addPack(c, s)
      : (V.packs[c] = f({}, V.packs[c] || {}, s));
  }
  var z = {};
  try {
    "undefined" != typeof window && (z = window);
  } catch (c) {}
  var l = (z.navigator || {}).userAgent,
    h = void 0 === l ? "" : l,
    v = z,
    m = (~h.indexOf("MSIE") || h.indexOf("Trident/"),
