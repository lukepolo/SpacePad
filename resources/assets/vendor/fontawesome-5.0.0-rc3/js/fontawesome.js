...
(function() {
  ...
  function makeInlineSvgAbstract(params) {
    ...
    var content = {
      ...
      attributes: _extends(
        ...
        defineProperty(_babelHelpers$extends, DATA_FA_REPLACEMENT, "true"),
  ...
  function makeLayersTextAbstract(params) {
    ...
    var attributes = _extends(
      ...
      defineProperty(_babelHelpers$extends2, DATA_FA_REPLACEMENT, "true"),
    ...
    disableObservation(function() {
      toArray(root.querySelectorAll("*")).reduce(function(acc, node) {
        [":before", ":after"].forEach(function(pos) {
          ...
          var hasReplacement = child
            ? !!child.getAttribute(DATA_FA_PSEUDO_ELEMENT)
            : false;
  ...
  function onTree(root) {
    ...
    var mutations = toArray(root.querySelectorAll(prefixesDomQuery)).reduce(
      function(acc, node) {
  ...
  var baseStyles = ___$insertStyle(
  ...
  function findIconDefinition(params) {
    ...
    return (
      ...
      iconFromMapping(namespace.packs, prefix, iconName)
    );
  }
  ...
  var api = {
    ...
    icon: function icon(iconDefinition) {
      ...
      var foundIcon = iconDefinition.icon
        ? iconDefinition
  ...
  Object.defineProperty(api, "config", {
    get: function get() {
      var autoReplaceSvg = config.autoReplaceSvg,
        ...
        rest = objectWithoutProperties(config, [
          "autoReplaceSvg",
          "observeMutations",
          "showMissingIcons"
        ]);
  ...
  function bootstrap() {
    ...
    namespace.hooks = _extends({}, namespace.hooks, {
      addPack: function addPack(prefix, icons) {
        namespace.packs[prefix] = _extends(
          {},
          namespace.packs[prefix] || {},
          icons
        );
