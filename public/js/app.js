...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "columns" }, [
      _c("div", { staticClass: "column is-half button" }, [
        _vm._v("\n                        Bookings\n                    ")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "column is-half button" }, [
...
var getTimeHeightStyle = function getTimeHeightStyle(startDate, endDate) {
  ...
  var startDateParsedHours = startDateParsed.format('HH') * 6;
  var startDateParsedMinutes = startDateParsed.format('mm');

  var endDateParsed = parseDate(endDate);
  var endDateParsedHours = endDateParsed.format('HH') * 6 - startDateParsedHours;
  var endDateParsedMinutes = endDateParsed.format('mm');

  // todo - n eed to convert to percetnage then * by 6
  console.info('top:' + startDateParsedHours + '.' + startDateParsedMinutes + 'em; height:' + endDateParsedHours + '.' + endDateParsedMinutes + 'em;');
